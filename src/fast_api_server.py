...
def run_periodic_review(event_name: str) -> Dict[str, str]:
    ...
    try:
        ...
        # Use PostgreSQL connection for ChessAnalyzer
        # Convert asyncpg URL to sync format for analysis module
        db_path = DB_URL
        ...
        filename = f"performance_review_{event_name.replace(' ', '_')}.txt"
